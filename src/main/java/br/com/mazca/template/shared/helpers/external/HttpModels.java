package br.com.mazca.template.shared.helpers.external;

import lombok.Getter;
import org.springframework.http.HttpStatus;
import br.com.mazca.template.shared.helpers.external.ExternalInterface.IRequest;
import br.com.mazca.template.shared.helpers.external.ExternalInterface.IResponse;
...
public final class HttpModels {
    ...
    public final static class HttpResponse implements IResponse {
        ...
        public HttpResponse(final HttpStatus statusCode, final Map<String, Object> body, final Map<String, Object> headers) {
